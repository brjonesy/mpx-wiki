...
The two parts on the images are the "Y_endstop_A.STL" and the "Y_endstop_[a]_B.STL" You can find them on the official MagicPhoenix github in the "Printed parts" folder.
